...
export class VendorProductSeed {
    private static prisma = new PrismaClient();

    // public static async clear() {
    //     await this.prisma.vendorProduct.deleteMany({});
    //     console.log('🗑️ Cleared vendor products');
    // }
    ...
    public static async seed() {
        try {
            ...
            // Make sure these vendors and products exist in your database
            const vendorProducts = [
                { vendor_id: 1, product_id: 1 }, // Vendor 1 - Product 1
                { vendor_id: 1, product_id: 2 }, // Vendor 1 - Product 2
                { vendor_id: 1, product_id: 3 }, // Vendor 1 - Product 3
            ];
            ...
            console.log('✅ Vendor products seeded successfully');
        } catch (error) {
            console.error('🐞 Error seeding VendorProducts:', error);
            throw error;
        } finally {
